...
# Use an environment variable for the database path to ensure compatibility
db_path = os.environ.get("DATABASE_URL", "phone_numbers.db")
...
def add_phone_number(phone_number, Client_code):
    ...
    # Validate the Client_code length
...
# Ensure the database connection is closed properly when the script ends
import atexit
